...
type Frontmatter = {
  ...
  readonly notion_page_id: Maybe<Scalars['String']>;
};
...
type Frontmatter_updated_atArgs = {
  formatString: Maybe<Scalars['String']>;
  fromNow: Maybe<Scalars['Boolean']>;
  difference: Maybe<Scalars['String']>;
  locale: Maybe<Scalars['String']>;
...
type FrontmatterFilterInput = {
  ...
  readonly notion_page_id: Maybe<StringQueryOperatorInput>;
};
...
type FileFieldsEnum =
  ...
  | 'childrenMarkdownRemark.frontmatter.updated_at'
  | 'childrenMarkdownRemark.frontmatter.source'
  | 'childrenMarkdownRemark.frontmatter.notion_page_id'
  ...
  | 'childMarkdownRemark.frontmatter.updated_at'
  | 'childMarkdownRemark.frontmatter.source'
  | 'childMarkdownRemark.frontmatter.notion_page_id'
...
type SiteSiteMetadataFilterInput = {
  ...
  readonly contacts: Maybe<SiteSiteMetadataContactsFilterInput>;
};
...
type SiteFieldsEnum =
  ...
  | 'siteMetadata.contacts.mail'
  | 'siteMetadata.contacts.instagram'
  | 'siteMetadata.contacts.github'
  | 'polyfill'
  | 'pathPrefix'
  | 'jsxRuntime'
  | 'trailingSlash'
...
type BioQuery = { readonly allFile: { readonly edges: ReadonlyArray<{ readonly node: { readonly childImageSharp: Maybe<Pick<ImageSharp, 'gatsbyImageData'>> } }> }, readonly site: Maybe<{ readonly siteMetadata: Maybe<{ readonly author: Maybe<Pick<Author, 'name' | 'summary'>>, readonly contacts: Maybe<Pick<SiteSiteMetadataContacts, 'mail' | 'github' | 'instagram'>> }> }> };

type LayoutQueryVariables = Exact<{ [key: string]: never; }>;


type LayoutQuery = { readonly site: Maybe<{ readonly siteMetadata: Maybe<{ readonly author: Maybe<Pick<Author, 'name'>> }> }> };
